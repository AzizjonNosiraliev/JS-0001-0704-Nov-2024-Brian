...
const outputBox = document.getElementById('out-box');
// 2. Get text input fields, where the enters their name:
const firstNameImput = document.getElementById('first-name');
const lastNameImput = document.getElementById('last-name');
