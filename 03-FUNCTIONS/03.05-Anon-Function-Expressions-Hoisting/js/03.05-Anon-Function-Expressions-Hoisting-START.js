...
console.log('var varmint:',varmint); // undefined
var varmint = 'possom';
console.log('var varmint:',varmint); // possum
...
// console.log(welcomeUser('Jane1')); // ReferenceError: Cannot access 'welcomeUser' before initialization
...
5. Get the 5 buttons, each of which will call a different type of function:
...
function onBtn1Click() {
    out1.textContent = "Hello from function declaration!";
} 
...
const onBtn2Click = function() {
    out2.textContent = "Hello from function expression!";
} 
...
btn3.addEventListener('click', function() {
    out3.textContent = "Hello from inline anonymus callback function!";
});
...
btn4.onclick = function() {
    out4.textContent = "Hello from onclick set equal to anonymus callback function!";
}
...
function greetByName(firstName) {
    out5.textContent = `Welcome back, ${firstName}`;
}
...
function greet(name, callback) {
    out6.textContent = `Hello, ${name}!`;
    callback();
}

btn6.addEventListener('click', function() {
    greet ('Zack', greetAgain);
});

function greetAgain() {
    out6.textContent += " Hello again from callback";
}
