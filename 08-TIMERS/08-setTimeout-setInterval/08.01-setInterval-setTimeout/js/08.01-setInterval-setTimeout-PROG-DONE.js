...
const aniOutput = document.querySelector('#animals');
aniOutput.innerHTML = '';
// let counter = 0;
// let animalInterval = setInterval(() => {
//     counter ++;
//     r = ~~(Math.random()*animals.length);
//     if(counter < 10){
//         aniOutput.innerHTML += `${animals[r]} `;
//         animals.splice(r,1);
//     } else {
...
// let animalsInteval = setInterval(() => {
//     let r = ~~(Math.random() * animalsCopy.length);
//     aniOutput.textContent += animalsCopy[r] + " ";
//     animalsCopy.splice(r, 1);
//     if(!animalsCopy.length) {
//       aniOutput.textContent += "\nALL DONE!!!";
//       clearInterval(animalsInteval);
//     }
...
// const animalsCopy = [...animals];
// let animalsInteval = setInterval(() => {
//     animalsCopy.sort(() => Math.random() - 0.5);
//     aniOutput.textContent += animalsCopy.pop() + " ";
//     if(!animalsCopy.length) {
//       aniOutput.textContent += "\nALL DONE!!!";
//       clearInterval(animalsInteval);
//     }
//     console.log('still going...', animalsCopy.length + ' animals left to go');
// }, 500);
...
function findFactorial(num) {
  // +num to convert stringy number to actual number
...
let num = 2;
const factorialH2 = document.getElementById('factorial');
const findFactorialInput = document.querySelector('#find-factorial');
findFactorialInput.addEventListener('change', factorialify);

// function outputs "find factorial process", 
// step-by-step:
function factorialify() {
  // get value inputted by user and make it a real numer
  let num = +findFactorialInput.value;
