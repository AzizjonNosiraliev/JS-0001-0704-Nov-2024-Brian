...
const API_KEY = "AY2lDXFs1vykJhyGDLxBcw53ZL1sG4DEUfq4nsQ1e8GV2YkS95MDgq1wnWGRwadA0dkC88lndVIPPYZTMiSlsvPtuZO3lOLaoGogxmmum03HucjwwUSaaaFP4VLMhTT";
//API_KEY = true; // ERROR: Assigment to constant variable
// const for objects
...
let fruitsArr = ['apple', 'kiwi', 'pineapple'];
...
//fruits = 'vegies'; // ERROR: Assignment to constant variable
// const fruits = "whoops";
...
veggies.push('carrot', 'beet', 'broccoli', 'cucumber');
// 'carrot', 'beet', 'arugula', 'cucumber';
...
// [3, 5, 220, 2, 17, 105, 45, 65, 1008, 25;
...
console.log(nums); // [1008, 105, 17, 2, 220, 25, 3, 45, 5, 65]
    ...
    //LOW - ' '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz - HIGH
/* 
...
*/
const hodgePodge = [23, 1001, 'cat', 'Cadillac', 'dog', 'Dodge', ' '];
hodgePodge.sort();
...
console.log(); // ['papaya', 'lime', 'lemon', 'kiwi', 'grape', 'blueberry', 'banana','apricot']
