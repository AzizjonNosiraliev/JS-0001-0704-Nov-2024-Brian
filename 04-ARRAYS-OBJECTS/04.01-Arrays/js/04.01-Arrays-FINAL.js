...
console.log('lastFruit:', lastFruit); // grape
...
//     .push() returns the updated array length:
let newLen = fruits.push('lemon', 'blueberry');
console.log('newLen:', newLen, fruits);
...
fruits.sort();
// the sort() method operates in place on the array itself, as opposed to returning a copy; the original array changes, proving that arrays are mutable
...
// pop() does not take an argument -- none needed; it just
// pops the last item, whatever it may be
...
// 26. Call the sort method on the nums array, passing in the callback function. The result is properly sorted numbers:
nums.sort(function(a,b) {
    return a - b; // b - a is descending
});
...
fruits.reverse();
console.log('fruits:', fruits); // ['papaya', 'lime', 'lemon', 'kiwi', 'grape', 'blueberry', 'banana','apricot']
