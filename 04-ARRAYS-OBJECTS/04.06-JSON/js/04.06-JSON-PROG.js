...
// 'Green Anaconda'
console.log(animalsObj['giraffe'].class); // mammal (bison or giraffe)
console.log(animalsObj['Green Anaconda'].continent); // South America
...
console.log('animalsArrFromObjKeys:', animalsArrFromObjKeys);
...
console.log('animalPropsFromKeys:', animalPropsFromKeys);
// ['class', 'herbivore', 'continent', 'wildPop', 'captivity']

// Object.vaues(obj) returns array of values of object argument:
...
*/
console.log(typeof(animalsArr), animalsArr); 
