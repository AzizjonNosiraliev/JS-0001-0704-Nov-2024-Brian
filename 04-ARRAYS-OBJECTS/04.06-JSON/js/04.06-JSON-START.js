...
// 1B.
console.log("\n\n\nCHALLANGE!");
// CHALLENGE: Get the following from animalsObj;
console.log("American Bison belongs to - ",animalsObj['American bison'].class); // mammal (as American Bison class)
console.log("American Bison wild population is - ", animalsObj['American bison'].wildPop); // 20000 (as American Bison wildPop)
console.log("Green Anaconda belongs to - ", animalsObj['Green Anaconda'].class); // reptile (as Green Anaconda class)
console.log("Penguin is a ",animalsObj['penguin'].class); // bird (as penguin class)
console.log("Penguins live in:",animalsObj['penguin'].continent); // Antarctica (as penguin continent)
console.log("American bison",animalsObj["American bison"]); 
//   class: 'mammal',
//   herbivore: true,
//   continent: 'North America',
//   wildPop: 20000,
...
const animalKeysArr = Object.keys(animalsObj);
console.log('animalKeysArr:', animalKeysArr);

const animalKeyTipe = Object.keys(animalsObj.penguin);
console.log('animalKeyTipe:', animalKeyTipe);
...
console.log('giraffeValuesArr:', giraffeValuesArr);
// ['mammal', true, 'Africa', 70000, 2000]
// an array of mixed data types
const penguinValuesArr = Object.values(animalsObj.penguin);
console.log('penguinValuesArr:', penguinValuesArr);
...
*/
console.log('animalObj datatype:\n', typeof(animalsObj));
console.log('animalObj\n', animalsObj);

// 2. Stringify the array of objects, saving the result to a variable:
// const animalsJS
let animalsJson = JSON.stringify(animalsObj);
console.log('animalsJson datatype:\n', typeof(animalsJson));
...
*/
let json = `{"American bison":{"class":"mammal","herbivore":true,"continent":"North America","wildPop":20000,"captivity":400000},"Green Anaconda":{"class":"reptile","herbivore":false,"continent":"South America","wildPop":3700000,"captivity":50000},"giraffe":{"class":"mammal","herbivore":true,"continent":"Africa","wildPop":70000,"captivity":2000},"penguin":{"class":"bird","herbivore":false,"continent":"Antarctica","wildPop":70000,"captivity":2000}}`;
...
const animalObjFromJson = JSON.parse(json);

// 5. Log the result and check the Console. We are back where we started:
console.log('animalObjFromJson:\n', animalObjFromJson);
console.log(animalObjFromJson.penguin.class); // bird (penguin)
console.log(animalObjFromJson.giraffe.continent); // Africa
...
const shallowAnacondaObj = animalsObj["Green Anaconda"];
console.log('shallowAnacondaObj:\n', shallowAnacondaObj);

// 7. Make a few changes to the Shallow anaconda object:
shallowAnacondaObj.behaviors = ['ambusing prey in shallow water', 'crushing hapless victims', 'slithering', 'basking in sun'];
...
*/
// const deep
const deepAnacondaObj = {...animalsObj["Green Anaconda"]};
console.log('{... deepAnacondaObj}:\n', deepAnacondaObj);

// 8C. Make a few changes to the Deep anaconda object:
deepAnacondaObj.name = "Denny the Deep Anaconda";

// increment by 2
// 'ambusing prey in deep water', 'crushing prey', 'napping to digest meal', 'slithering', 'climbing trees', 'basking in sun';
console.log("deepAnacondaObj:", deepAnacondaObj);
...
const deepAnacondaFromJson = JSON.parse(JSON.stringify(animalsObj["Green Anaconda"]));
deepAnacondaFromJson.weightKG = 150;
// 9B. Make sure the nested JSON operation worked:
console.log('deepAnacondaFromJson:\n', deepAnacondaFromJson);
...
console.log('deepAnacondaFromJSON:\n', deepAnacondaFromJson);
console.log('animalsObj["Green Anaconda"]n', animalsObj["Green Anaconda"]);
