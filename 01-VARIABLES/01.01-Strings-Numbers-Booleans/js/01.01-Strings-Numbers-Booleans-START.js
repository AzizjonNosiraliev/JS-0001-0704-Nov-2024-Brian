...
console.log (price1 + price2 * 2);
console.log (price3 - price1);
console.log (price1 * price2 * 2);
console.log (price3 / price2 * 2);
...
let isOnline = true;
let pemiumMember = false;

console.log(isOnline, pemiumMember); // true, false
...
console.log('day:', day, typeof(day)); // undefined undefined undefined undefined
...
let sportsCar = "Porsche";
console.log('2.', 'sportsCar:', sportsCar, typeof(sportsCar));
...
let done = 22.5;
console.log('4.', 'done:', done, typeof(done));

// 5. Dubug this string variable:
let miles = 'marathon';
console.log('5.', 'miles', miles, typeof(miles));

// 6. Dubug this string variable:
let Bar = "candy bar";
console.log('6.', 'Bar', Bar, typeof(Bar));
